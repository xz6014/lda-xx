...
function (documents, K, vocab, num.e.iterations, num.m.iterations,
    ...
    lambda = 10, regularise = FALSE, method = "sLDA", trace = 0L, MaxNWts=3000, initial = NULL, compute.log.likelihood = FALSE)
{
    ...
    result <- .slda.collapsed.gibbs.sampler(documents, K, vocab,
        ...
        variance[1], logistic, method[1], lambda = lambda, trace = trace, initial = initial, compute.log.likelihood = compute.log.likelihood)
